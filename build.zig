...
comptime {
    ...
    const min_zig = std.SemanticVersion.parse("0.12.0-dev.3397") catch unreachable;
...
fn configureVendorLibraries(exe: *std.Build.Step.Compile, target: std.Build.ResolvedTarget, optimize: std.builtin.OptimizeMode) void {
    ...
    // This includes raylib as a dependency.
    exe.addLibraryPath(b.path("libs/raylib/src"));
