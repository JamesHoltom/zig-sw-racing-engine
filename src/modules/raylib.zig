...
pub const struct_Matrix = extern struct {
    m0: f32 = std.mem.zeroes(f32),
    m4: f32 = std.mem.zeroes(f32),
    m8: f32 = std.mem.zeroes(f32),
    m12: f32 = std.mem.zeroes(f32),
    m1: f32 = std.mem.zeroes(f32),
    m5: f32 = std.mem.zeroes(f32),
    m9: f32 = std.mem.zeroes(f32),
    m13: f32 = std.mem.zeroes(f32),
    m2: f32 = std.mem.zeroes(f32),
    m6: f32 = std.mem.zeroes(f32),
    m10: f32 = std.mem.zeroes(f32),
    m14: f32 = std.mem.zeroes(f32),
    m3: f32 = std.mem.zeroes(f32),
    m7: f32 = std.mem.zeroes(f32),
    m11: f32 = std.mem.zeroes(f32),
    m15: f32 = std.mem.zeroes(f32),
};
pub const Matrix = struct_Matrix;
pub const struct_Color = extern struct {
    r: u8 = std.mem.zeroes(u8),
    g: u8 = std.mem.zeroes(u8),
    b: u8 = std.mem.zeroes(u8),
    a: u8 = std.mem.zeroes(u8),
};
pub const Color = struct_Color;
pub const struct_Rectangle = extern struct {
    x: f32 = std.mem.zeroes(f32),
    y: f32 = std.mem.zeroes(f32),
    width: f32 = std.mem.zeroes(f32),
    height: f32 = std.mem.zeroes(f32),
};
...
pub const struct_Image = extern struct {
    ...
    mipmaps: c_int = std.mem.zeroes(c_int),
    format: c_int = std.mem.zeroes(c_int),
};
pub const Image = struct_Image;
pub const struct_Texture = extern struct {
    id: c_uint = std.mem.zeroes(c_uint),
    width: c_int = std.mem.zeroes(c_int),
    height: c_int = std.mem.zeroes(c_int),
    mipmaps: c_int = std.mem.zeroes(c_int),
    format: c_int = std.mem.zeroes(c_int),
...
pub const struct_NPatchInfo = extern struct {
    ...
    layout: c_int = std.mem.zeroes(c_int),
};
pub const NPatchInfo = struct_NPatchInfo;
pub const struct_GlyphInfo = extern struct {
    value: c_int = std.mem.zeroes(c_int),
    offsetX: c_int = std.mem.zeroes(c_int),
    offsetY: c_int = std.mem.zeroes(c_int),
    advanceX: c_int = std.mem.zeroes(c_int),
    image: Image = std.mem.zeroes(Image),
};
pub const GlyphInfo = struct_GlyphInfo;
pub const struct_Font = extern struct {
    baseSize: c_int = std.mem.zeroes(c_int),
    glyphCount: c_int = std.mem.zeroes(c_int),
    glyphPadding: c_int = std.mem.zeroes(c_int),
    texture: Texture2D = std.mem.zeroes(Texture2D),
    recs: [*c]Rectangle = std.mem.zeroes([*c]Rectangle),
    glyphs: [*c]GlyphInfo = std.mem.zeroes([*c]GlyphInfo),
};
pub const Font = struct_Font;
pub const struct_Camera3D = extern struct {
    position: Vector3 = std.mem.zeroes(Vector3),
    target: Vector3 = std.mem.zeroes(Vector3),
    up: Vector3 = std.mem.zeroes(Vector3),
    fovy: f32 = std.mem.zeroes(f32),
    projection: c_int = std.mem.zeroes(c_int),
};
pub const Camera3D = struct_Camera3D;
pub const Camera = Camera3D;
pub const struct_Camera2D = extern struct {
    offset: Vector2 = std.mem.zeroes(Vector2),
    target: Vector2 = std.mem.zeroes(Vector2),
    rotation: f32 = std.mem.zeroes(f32),
    zoom: f32 = std.mem.zeroes(f32),
};
pub const Camera2D = struct_Camera2D;
pub const struct_Mesh = extern struct {
    vertexCount: c_int = std.mem.zeroes(c_int),
    triangleCount: c_int = std.mem.zeroes(c_int),
    vertices: [*c]f32 = std.mem.zeroes([*c]f32),
    texcoords: [*c]f32 = std.mem.zeroes([*c]f32),
    texcoords2: [*c]f32 = std.mem.zeroes([*c]f32),
    normals: [*c]f32 = std.mem.zeroes([*c]f32),
    tangents: [*c]f32 = std.mem.zeroes([*c]f32),
    colors: [*c]u8 = std.mem.zeroes([*c]u8),
    indices: [*c]c_ushort = std.mem.zeroes([*c]c_ushort),
    animVertices: [*c]f32 = std.mem.zeroes([*c]f32),
    animNormals: [*c]f32 = std.mem.zeroes([*c]f32),
    boneIds: [*c]u8 = std.mem.zeroes([*c]u8),
    boneWeights: [*c]f32 = std.mem.zeroes([*c]f32),
    vaoId: c_uint = std.mem.zeroes(c_uint),
    vboId: [*c]c_uint = std.mem.zeroes([*c]c_uint),
};
pub const Mesh = struct_Mesh;
pub const struct_Shader = extern struct {
    id: c_uint = std.mem.zeroes(c_uint),
    locs: [*c]c_int = std.mem.zeroes([*c]c_int),
};
pub const Shader = struct_Shader;
pub const struct_MaterialMap = extern struct {
    texture: Texture2D = std.mem.zeroes(Texture2D),
    color: Color = std.mem.zeroes(Color),
    value: f32 = std.mem.zeroes(f32),
};
pub const MaterialMap = struct_MaterialMap;
pub const struct_Material = extern struct {
    shader: Shader = std.mem.zeroes(Shader),
    maps: [*c]MaterialMap = std.mem.zeroes([*c]MaterialMap),
    params: [4]f32 = std.mem.zeroes([4]f32),
};
pub const Material = struct_Material;
pub const struct_Transform = extern struct {
    translation: Vector3 = std.mem.zeroes(Vector3),
    rotation: Quaternion = std.mem.zeroes(Quaternion),
    scale: Vector3 = std.mem.zeroes(Vector3),
};
pub const Transform = struct_Transform;
pub const struct_BoneInfo = extern struct {
    name: [32]u8 = std.mem.zeroes([32]u8),
    parent: c_int = std.mem.zeroes(c_int),
};
pub const BoneInfo = struct_BoneInfo;
pub const struct_Model = extern struct {
    transform: Matrix = std.mem.zeroes(Matrix),
    meshCount: c_int = std.mem.zeroes(c_int),
    materialCount: c_int = std.mem.zeroes(c_int),
    meshes: [*c]Mesh = std.mem.zeroes([*c]Mesh),
    materials: [*c]Material = std.mem.zeroes([*c]Material),
    meshMaterial: [*c]c_int = std.mem.zeroes([*c]c_int),
    boneCount: c_int = std.mem.zeroes(c_int),
    bones: [*c]BoneInfo = std.mem.zeroes([*c]BoneInfo),
    bindPose: [*c]Transform = std.mem.zeroes([*c]Transform),
};
pub const Model = struct_Model;
pub const struct_ModelAnimation = extern struct {
    boneCount: c_int = std.mem.zeroes(c_int),
    frameCount: c_int = std.mem.zeroes(c_int),
    bones: [*c]BoneInfo = std.mem.zeroes([*c]BoneInfo),
    framePoses: [*c][*c]Transform = std.mem.zeroes([*c][*c]Transform),
    name: [32]u8 = std.mem.zeroes([32]u8),
};
pub const ModelAnimation = struct_ModelAnimation;
pub const struct_Ray = extern struct {
    position: Vector3 = std.mem.zeroes(Vector3),
    direction: Vector3 = std.mem.zeroes(Vector3),
};
pub const Ray = struct_Ray;
pub const struct_RayCollision = extern struct {
    hit: bool = std.mem.zeroes(bool),
    distance: f32 = std.mem.zeroes(f32),
    point: Vector3 = std.mem.zeroes(Vector3),
    normal: Vector3 = std.mem.zeroes(Vector3),
};
pub const RayCollision = struct_RayCollision;
pub const struct_BoundingBox = extern struct {
    min: Vector3 = std.mem.zeroes(Vector3),
    max: Vector3 = std.mem.zeroes(Vector3),
};
pub const BoundingBox = struct_BoundingBox;
pub const struct_Wave = extern struct {
    frameCount: c_uint = std.mem.zeroes(c_uint),
    sampleRate: c_uint = std.mem.zeroes(c_uint),
    sampleSize: c_uint = std.mem.zeroes(c_uint),
...
pub const struct_AudioStream = extern struct {
    buffer: ?*rAudioBuffer = std.mem.zeroes(?*rAudioBuffer),
    processor: ?*rAudioProcessor = std.mem.zeroes(?*rAudioProcessor),
    sampleRate: c_uint = std.mem.zeroes(c_uint),
    sampleSize: c_uint = std.mem.zeroes(c_uint),
    channels: c_uint = std.mem.zeroes(c_uint),
};
...
pub const struct_Sound = extern struct {
    stream: AudioStream = std.mem.zeroes(AudioStream),
    frameCount: c_uint = std.mem.zeroes(c_uint),
};
...
pub const struct_Music = extern struct {
    stream: AudioStream = std.mem.zeroes(AudioStream),
    frameCount: c_uint = std.mem.zeroes(c_uint),
    looping: bool = std.mem.zeroes(bool),
    ctxType: c_int = std.mem.zeroes(c_int),
    ctxData: ?*anyopaque = std.mem.zeroes(?*anyopaque),
};
pub const Music = struct_Music;
pub const struct_VrDeviceInfo = extern struct {
    hResolution: c_int = std.mem.zeroes(c_int),
    vResolution: c_int = std.mem.zeroes(c_int),
    hScreenSize: f32 = std.mem.zeroes(f32),
    vScreenSize: f32 = std.mem.zeroes(f32),
    eyeToScreenDistance: f32 = std.mem.zeroes(f32),
    lensSeparationDistance: f32 = std.mem.zeroes(f32),
    interpupillaryDistance: f32 = std.mem.zeroes(f32),
    lensDistortionValues: [4]f32 = std.mem.zeroes([4]f32),
    chromaAbCorrection: [4]f32 = std.mem.zeroes([4]f32),
};
pub const VrDeviceInfo = struct_VrDeviceInfo;
pub const struct_VrStereoConfig = extern struct {
    projection: [2]Matrix = std.mem.zeroes([2]Matrix),
    viewOffset: [2]Matrix = std.mem.zeroes([2]Matrix),
    leftLensCenter: [2]f32 = std.mem.zeroes([2]f32),
    rightLensCenter: [2]f32 = std.mem.zeroes([2]f32),
    leftScreenCenter: [2]f32 = std.mem.zeroes([2]f32),
    rightScreenCenter: [2]f32 = std.mem.zeroes([2]f32),
    scale: [2]f32 = std.mem.zeroes([2]f32),
    scaleIn: [2]f32 = std.mem.zeroes([2]f32),
};
pub const VrStereoConfig = struct_VrStereoConfig;
pub const struct_FilePathList = extern struct {
    capacity: c_uint = std.mem.zeroes(c_uint),
    count: c_uint = std.mem.zeroes(c_uint),
    paths: [*c][*c]u8 = std.mem.zeroes([*c][*c]u8),
};
pub const FilePathList = struct_FilePathList;
pub const struct_AutomationEvent = extern struct {
    frame: c_uint = std.mem.zeroes(c_uint),
    type: c_uint = std.mem.zeroes(c_uint),
    params: [4]c_int = std.mem.zeroes([4]c_int),
};
pub const AutomationEvent = struct_AutomationEvent;
pub const struct_AutomationEventList = extern struct {
    capacity: c_uint = std.mem.zeroes(c_uint),
    count: c_uint = std.mem.zeroes(c_uint),
    events: [*c]AutomationEvent = std.mem.zeroes([*c]AutomationEvent),
};
...
pub const RL_MALLOC = @compileError("unable to translate macro: undefined identifier `malloc`"); // /home/jholtom/Programming/zig-sw-racing-engine/libs/raylib/src/raylib.h:127:13
pub const RL_CALLOC = @compileError("unable to translate macro: undefined identifier `calloc`"); // /home/jholtom/Programming/zig-sw-racing-engine/libs/raylib/src/raylib.h:130:13
pub const RL_REALLOC = @compileError("unable to translate macro: undefined identifier `realloc`"); // /home/jholtom/Programming/zig-sw-racing-engine/libs/raylib/src/raylib.h:133:13
pub const RL_FREE = @compileError("unable to translate macro: undefined identifier `free`"); // /home/jholtom/Programming/zig-sw-racing-engine/libs/raylib/src/raylib.h:136:13
